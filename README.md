...
The admin page has a Usage tab showing today's activity, storage, and every free-plan limit. Still to come in Phase 4: editing pubs and operators, and a switch to clear the sample tap lists. Operator core ranges are planned for Phase 5.
